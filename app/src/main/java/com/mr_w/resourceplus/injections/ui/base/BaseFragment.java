...
import com.mr_w.resourceplus.injections.di.component.DaggerFragmentComponent;
...
public abstract class BaseFragment<T extends ViewDataBinding, V extends BaseViewModel> extends Fragment {
    ...
    private FragmentComponent getBuildComponent() {
        return DaggerFragmentComponent.builder()
                .appComponent(((ResourcePlusApplication) (getContext().getApplicationContext())).appComponent)
