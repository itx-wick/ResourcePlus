package com.mr_w.resourceplus.loaders;
...
public class DocumentLoader extends CursorLoader {
    ...
    private DocumentLoader(Context context, Uri uri, String[] projection, String selection,
...
//        setSelectionArgs(selectionArgs);
    ...
    public DocumentLoader(Context context, String[] selectionArgs) {
        super(context);
        setProjection(FILE_PROJECTION);
        setUri(MediaStore.Files.getContentUri("external"));
        setSortOrder(MediaStore.Files.FileColumns.DATE_ADDED + " DESC");
