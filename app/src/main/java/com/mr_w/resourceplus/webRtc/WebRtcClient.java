package com.mr_w.resourceplus.webRtc;
...
public class WebRtcClient {
    ...
    private class MessageHandler {
        ...
        private final Emitter.Listener onId = new Emitter.Listener() {
            @Override
            public void call(Object... args) {
...
//        iceServers.add(new PeerConnection.IceServer("turn:129.28.101.171:3478", "cx", "cx1234"));
//        iceServers.add(new PeerConnection.IceServer("turn:39.105.125.160:3478", "helloword", "helloword"));
//        iceServers.add(new PeerConnection.IceServer("stun:162.244.77.2:8443?transport=udp", "myTurnServer", "ecd0ad4568c868c"));
//        iceServers.add(new PeerConnection.IceServer("turn:webrtcweb.com:7788", "muazkh", "muazkh"));
//        iceServers.add(new PeerConnection.IceServer("turn:162.244.77.2:8443?transport=tcp", "myTurnServer", "ecd0ad4568c868c"));
//
...
//        audioConstraints.mandatory.add(new MediaConstraints.KeyValuePair("googHighpassFilter", "true"));
    ...
    public void switchCamera() {
        if (capturer != null) {
            if (capturer instanceof VideoCapturerAndroid)
                ((VideoCapturerAndroid) capturer).switchCamera(null);
        }
    }
}